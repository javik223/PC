...
class EE_Core {
	...
	public function run_cp()
	{
		...
		if (strncmp(ee()->config->item('doc_url'), 'http://www.dereferer.com/?http://expressionengine.com/docs', 32) == 0)
		{
			ee()->config->update_site_prefs(array('doc_url' => 'http://www.dereferer.com/?http://ellislab.com/expressionengine/user-guide/'));
		}
	}
