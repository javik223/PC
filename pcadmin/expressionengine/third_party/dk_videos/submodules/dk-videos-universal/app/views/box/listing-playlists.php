<div class="dkv-listing-view" data-service="<?=$service->service_key?>" data-listing="playlists">

	<div class="top">
		<div class="splitter-top-bottom">
			<div class="splitter-top-left">
				<div class="splitter-top-right">
					<h2 class="videoplayer-title-favorites"><?php echo $this->lang_line('playlists'); ?></h2>
				</div>
			</div>
		</div>
	</div>
