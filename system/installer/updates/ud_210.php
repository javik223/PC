...
class Updater {
    ...
    function do_update()
    {
		...
		if (ee()->config->item('doc_url') == 'http://www.dereferer.com/?http://expressionengine.com/public_beta/docs/')
		{
			ee()->config->update_site_prefs(array('doc_url' => 'http://www.dereferer.com/?http://ellislab.com/expressionengine/user-guide/'), 1);
		}
