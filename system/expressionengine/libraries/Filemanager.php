...
class Filemanager {
	...
	public function _file_datasource($state, $params)
	{
		...
		$sync_files_url = (REQ == "CP") ?
			ee()->cp->masked_url('http://www.dereferer.com/?http://ellislab.com/expressionengine/user-guide/cp/content/files/sync_files.html') :
			'http://www.dereferer.com/?http://ellislab.com/expressionengine/user-guide/cp/content/files/sync_files.html';
